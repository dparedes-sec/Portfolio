export const projects = [
  {
    id: 'P1',
    category: { en: 'DEFENSIVE · PIPELINE SECURITY', es: 'DEFENSIVO · SEGURIDAD DE PIPELINES' },
    title: { en: 'Bioinformatics Pipeline Hardening', es: 'Hardening de Pipeline de Bioinformática' },
    severity: 'med',
    stack: ['Python', 'Docker', 'CI/CD', 'SAST', 'Linux'],
    bullets: {
      en: [
        'Secured a genomics data processing pipeline handling sensitive clinical datasets',
        'Implemented SAST scanning and dependency auditing in CI/CD workflow',
        'Applied CIS benchmark hardening to containerized environment',
        'Reduced attack surface by 60% through configuration review and remediation',
      ],
      es: [
        'Aseguré un pipeline de procesamiento de datos genómicos con datasets clínicos sensibles',
        'Implementé escaneo SAST y auditoría de dependencias en workflow CI/CD',
        'Aplicé hardening basado en benchmarks CIS al entorno containerizado',
        'Reduje la superficie de ataque en 60% mediante revisión de configuración y remediación',
      ],
    },
    repo: 'https://github.com/dparedes-sec/bioinformatics-pipeline-hardening',
  },
  {
    id: 'P2',
  ...
  },
  {
    ...
    bullets: {
      en: [
        ...
        'Developed compliance gap analysis for sensitive health data processing',
      ...
      es: [
        ...
        'Desarrollé análisis de brechas de cumplimiento para procesamiento de datos de salud sensibles',
  ...
  },
  {
    ...
    title: { en: 'Genomic Data Risk Assessment', es: 'Evaluación de Riesgos de Datos Genómicos' },
    severity: 'med',
    stack: ['NIST SP 800-30', 'CVSS v3.1', 'Risk Matrix', 'Threat Modeling'],
    bullets: {
      en: [
        'Conducted quantitative risk assessment for genomic data infrastructure',
      ...
      es: [
        'Realicé evaluación cuantitativa de riesgos para infraestructura de datos genómicos',
    ...
    repo: 'https://github.com/dparedes-sec/genomic-data-risk-assessment',
  },
]
